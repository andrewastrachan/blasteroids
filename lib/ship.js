...
//------------------------------------------------------
	...
	Ship.prototype.fireBullet = function() {
		if (!this.blasterReloading){
			...
			var that = this; 
			setTimeout(function(){ that.blasterReloading = false; }, this.rof);
		}
	};
	...
	//adjsutable rate of fire
	Ship.prototype.speedRate = function(score) {
		debugger;
		if (score % 150 === 0) {
			if (this.rof > 20) { this.rof -= 20; }
		}
	};
